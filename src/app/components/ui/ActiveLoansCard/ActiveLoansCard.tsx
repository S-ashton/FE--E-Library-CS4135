      ...
      return (
        <section className={styles.card}>
          ...
          <p className={styles.message}>
            You have no books on loan (nothing active or overdue).
          </p>
        </section>
      );
        ...
        <section className={styles.card}>
          ...
          <div className={styles.loansGridWrapper}>
            {borrowedBooks.map((book) => {
              ...
              const showStaffFineNote = isOverdue || hasFine;
                ...
                >
                  <div className={styles.loanCardTop}>
                    ...
                    <div className={styles.loanCardBody}>
                      {isOverdue ? (
                        <p className={styles.overdueBadge}>Overdue</p>
                      ) : null}
                      ...
                      {showStaffFineNote ? (
                        <p className={styles.staffFineNote}>
                          Please contact a staff member to sort out your fine.
                        </p>
                      ) : null}
                    </div>
                  </div>
